...
var HVAutocomplete = (function() {
  function HVAutocomplete(config) {
    ...
    var statusError = this.checkOnType(this.config);
  ...
  _createClass(HVAutocomplete, [
    ...
    },
    {
      ...
      value: function build() {
        ...
        this.divResult.setAttribute(
          "id",
          "hv-result-" + this.defaultConfig.prefix
        );
  ...
  _createClass(HVAutocompleteEvents, [
    ...
    },
    {
      ...
      value: function createWithCategoryResult(data) {
        ...
        for (var i = 0; i < keysData.length; i++) {
          ...
          if (isHaveCategory) {
            var buildResult = this.buildListWithCategory(
    ...
    },
    {
      ...
      value: function createDefaultResult(data, type, nameCategory) {
        ...
        var _defaultConfig = this.defaultConfig,
          maxLength = _defaultConfig.maxLength,
        ...
        var _loop = function _loop(key) {
          ...
          var findWord = _this3.config.globalSearch
            ? _this3.globalSearch(data[key].name)
            : _this3.defaultSearch(data[key].name);
    ...
    },
    {
      ...
      value: function buildListWithCategory(data, nameCategory) {
        var list = this.createDefaultResult(
          data,
          "with-category",
          nameCategory
        );
        ...
        var length = this.config.maxLength
